  ...
  return (
            ...
            >
                <div className="p-5 bg-white md:flex-1">
                    <form action="#" className="flex flex-col space-y-5">
                        ...
                        <p className="flex ">Nao tem conta ainda? <Link href={'/register'}><div className="text-blue-700 ml-3">Registrar</div></Link></p>
    ...
    <div className="rounded-md">
      ...
      {Object.values(providers).map(provider => (
        <div key={provider.id}>
          <button onClick={async () => {await signIn(provider.id)}} className="flex w-full gap-4 items-center justify-center p-4 border-b border-b-gray-100 hover:bg-socialBlue hover:text-white hover:border-b-socialBlue hover:rounded-md hover:shadow-md hover:shadow-gray-300 transition-all hover:scale-110">
